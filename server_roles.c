...
void* handle_client(void* arg) {
    ...
    if (strcmp(name, "admin") == 0) {
        ...
        if (strcmp(password, "admin1234") == 0) {
            strcpy(roles[client_count - 1], "admin");
            send(sock, "Admin access granted\n", 21, 0);
        } else {
            strcpy(roles[client_count - 1], "editor");
    ...
    while (1) {
        ...
        // ===== LIVE =====
            ...
            send(sock, "LIVE MODE (type exit_live)\n", 29, 0);
        }
        ...
        // ===== REQUEST =====
            ...
            if (strcmp(role, "editor") != 0 && strcmp(role, "admin") != 0) {
                send(sock, "No edit permission\n", 19, 0);
                continue;
            }
